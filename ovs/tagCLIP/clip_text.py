...
class_names_voc_context = ['aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'car', 'cat',
...
BACKGROUND_CATEGORY_VOC_CONTEXT = ['land', 'tree', 'lake', 'railway', 'railroad', 'helmet', 'cloud', 'house',
                                   'road', 'rock', 'street', 'valley', 'bridge']
